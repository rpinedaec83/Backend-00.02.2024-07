...
select * from Employees where EmployeeID in (1, 5, 8);
...
select products.ProductName, products.price, products.unit, categories.Categoryname from products Join Categories on Products.categoryID=categories.CategoryID;
...
Select Orders.OrderID,  
	...
	from orderdetails join Products on OrderDetails.ProductID=Products.ProductID join orders on Orderdetails.OrderID=Orders.OrderID;
...
select a.productid, b.productname, b.Price, b.unit, o.OrderDate 
from orderdetails a 
inner join products b on a.ProductID = b.productid 
