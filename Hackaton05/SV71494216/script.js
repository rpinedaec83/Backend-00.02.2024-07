...
const telefono1 = new Telefono("XSE987E", "94589315", "Samsung");
const tecnico1 = new Tecnico("Jose", ["Samsung", "iphone", "xiaomi"], 'diagnosticos');
const tecnico2 = new Tecnico("Maria", ["Samsung", "iphone", "xiaomi"], 'reparacion');
...
const telefono2 = new Telefono("Neyra", "945470325", "");
const tecnico3 = new Tecnico("Cusi", ["Samsung", "iphone", "xiaomi"], 'diagnosticos');
const diagnostico2 = new AreaDiagnostico('Cambio de funda', telefono2, tecnico3)
